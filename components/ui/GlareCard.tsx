...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    // --- PERUBAHAN 1: Mengganti gradien pelangi menjadi gradien nuansa cyan ---
    "--rainbow":
      "repeating-linear-gradient(0deg, rgb(21, 94, 117) calc(var(--step) * 1), rgb(6, 182, 212) calc(var(--step) * 2), rgb(165, 243, 252) calc(var(--step) * 3), rgb(6, 182, 212) calc(var(--step) * 4), rgb(21, 94, 117) calc(var(--step) * 5)) 0% var(--bg-y) / 200% 700% no-repeat",
    // --- PERUBAHAN 2: Menyesuaikan gradien diagonal agar lebih serasi dengan cyan ---
    "--diagonal":
      "repeating-linear-gradient(128deg, #083344 0%, hsl(180, 50%, 60%) 3.8%, hsl(180, 40%, 50%) 4.5%, hsl(180, 50%, 60%) 5.2%, #083344 10%, #083344 12%) var(--bg-x) var(--bg-y) / 300% no-repeat",
    "--shade":
